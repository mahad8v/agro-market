      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="max-w-2xl">
          ...
          <p className="text-lg text-green-100 mb-8 leading-relaxed">
            Shop directly from verified farmers and agricultural vendors. Get
            the freshest produce, grains, and organic products delivered to your
            door.
          </p>
          ...
          <div className="flex items-center gap-6 mt-10 text-sm text-green-100">
            <div className="flex items-center gap-2">
              <span className="text-yellow-300 font-bold text-lg">8+</span>
              <span>Vendors</span>
            </div>
            <div className="w-px h-6 bg-green-500" />
            <div className="flex items-center gap-2">
              <span className="text-yellow-300 font-bold text-lg">31+</span>
              <span>Products</span>
            </div>
            <div className="w-px h-6 bg-green-500" />
            <div className="flex items-center gap-2">
              <span className="text-yellow-300 font-bold text-lg">50+</span>
