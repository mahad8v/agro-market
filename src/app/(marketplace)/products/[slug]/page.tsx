...
//   console.log('dataaaaa', relatedData);
...
export default function ProductDetailPage({ params }: Props) {
  ...
  // ✅ Only fetch related products once category slug is known
  const categorySlug = product?.category?.slug;

  const { data: relatedData } = useProducts(
    categorySlug ? { category: categorySlug, limit: 5 } : undefined,
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <span className="mx-2">/</span>
        {/* ✅ Use category.slug and category.name */}
        <Link
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-5">
          <div className="flex flex-wrap gap-2">
            {/* ✅ Use category.name not category object */}
