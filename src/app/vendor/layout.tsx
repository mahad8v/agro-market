    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm">Senela Market</p>
        ...
        <div className="p-4 border-t border-gray-100">
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2 mb-1 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-8 h-8 bg-emerald-100 rounded-full flex items-center justify-center text-sm font-bold text-emerald-800">
              {user?.name?.[0] ?? 'V'}
            </div>
          </div>
        </header>
